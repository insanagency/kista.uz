    ...
    <div className="min-h-screen flex items-center justify-center bg-muted/30 p-4 transition-colors">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <img src="/soqqam-logo.svg" alt="Soqqam.uz" className="h-6 mx-auto mb-4 dark:hidden block" />
          <img src="/soqqam-logo-dark.svg" alt="Soqqam.uz" className="h-6 mx-auto mb-4 hidden dark:block" />
